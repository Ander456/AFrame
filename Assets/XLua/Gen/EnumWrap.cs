...
namespace XLua.CSObjectWrap
{
    ...
    public class BestHTTPHTTPMethodsWrap
    {
		public static void __Register(RealStatePtr L)
        {
		    ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		    Utils.BeginObjectRegister(typeof(BestHTTP.HTTPMethods), L, translator, 0, 0, 0, 0);
			Utils.EndObjectRegister(typeof(BestHTTP.HTTPMethods), L, translator, null, null, null, null, null);
			
			Utils.BeginClassRegister(typeof(BestHTTP.HTTPMethods), L, null, 8, 0, 0);

            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Get", BestHTTP.HTTPMethods.Get);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Head", BestHTTP.HTTPMethods.Head);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Post", BestHTTP.HTTPMethods.Post);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Put", BestHTTP.HTTPMethods.Put);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Delete", BestHTTP.HTTPMethods.Delete);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Patch", BestHTTP.HTTPMethods.Patch);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Merge", BestHTTP.HTTPMethods.Merge);
            

			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
            
            Utils.EndClassRegister(typeof(BestHTTP.HTTPMethods), L, translator);
        }
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            {
                translator.PushBestHTTPHTTPMethods(L, (BestHTTP.HTTPMethods)LuaAPI.xlua_tointeger(L, 1));
            }
            ...
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {
                ...
                {
                    translator.PushBestHTTPHTTPMethods(L, BestHTTP.HTTPMethods.Get);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Head"))
                {
                    translator.PushBestHTTPHTTPMethods(L, BestHTTP.HTTPMethods.Head);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Post"))
                {
                    translator.PushBestHTTPHTTPMethods(L, BestHTTP.HTTPMethods.Post);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Put"))
                {
                    translator.PushBestHTTPHTTPMethods(L, BestHTTP.HTTPMethods.Put);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Delete"))
                {
                    translator.PushBestHTTPHTTPMethods(L, BestHTTP.HTTPMethods.Delete);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Patch"))
                {
                    translator.PushBestHTTPHTTPMethods(L, BestHTTP.HTTPMethods.Patch);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Merge"))
                {
                    translator.PushBestHTTPHTTPMethods(L, BestHTTP.HTTPMethods.Merge);
                }
				else
                {
                    return LuaAPI.luaL_error(L, "invalid string for BestHTTP.HTTPMethods!");
                }
            ...
            {
                return LuaAPI.luaL_error(L, "invalid lua type for BestHTTP.HTTPMethods! Expect number or string, got + " + lua_type);
            }
    ...
    public class BestHTTPHTTPRequestStatesWrap
    {
		public static void __Register(RealStatePtr L)
        {
		    ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		    Utils.BeginObjectRegister(typeof(BestHTTP.HTTPRequestStates), L, translator, 0, 0, 0, 0);
			Utils.EndObjectRegister(typeof(BestHTTP.HTTPRequestStates), L, translator, null, null, null, null, null);
			
			Utils.BeginClassRegister(typeof(BestHTTP.HTTPRequestStates), L, null, 9, 0, 0);

            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Initial", BestHTTP.HTTPRequestStates.Initial);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Queued", BestHTTP.HTTPRequestStates.Queued);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Processing", BestHTTP.HTTPRequestStates.Processing);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Finished", BestHTTP.HTTPRequestStates.Finished);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Error", BestHTTP.HTTPRequestStates.Error);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Aborted", BestHTTP.HTTPRequestStates.Aborted);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "ConnectionTimedOut", BestHTTP.HTTPRequestStates.ConnectionTimedOut);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "TimedOut", BestHTTP.HTTPRequestStates.TimedOut);
            

			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
            
            Utils.EndClassRegister(typeof(BestHTTP.HTTPRequestStates), L, translator);
        }
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            if (lua_type == LuaTypes.LUA_TNUMBER)
            {
                translator.PushBestHTTPHTTPRequestStates(L, (BestHTTP.HTTPRequestStates)LuaAPI.xlua_tointeger(L, 1));
            }
            ...
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {
                ...
                {
                    translator.PushBestHTTPHTTPRequestStates(L, BestHTTP.HTTPRequestStates.Initial);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Queued"))
                {
                    translator.PushBestHTTPHTTPRequestStates(L, BestHTTP.HTTPRequestStates.Queued);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Processing"))
                {
                    translator.PushBestHTTPHTTPRequestStates(L, BestHTTP.HTTPRequestStates.Processing);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Finished"))
                {
                    translator.PushBestHTTPHTTPRequestStates(L, BestHTTP.HTTPRequestStates.Finished);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Error"))
                {
                    translator.PushBestHTTPHTTPRequestStates(L, BestHTTP.HTTPRequestStates.Error);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Aborted"))
                {
                    translator.PushBestHTTPHTTPRequestStates(L, BestHTTP.HTTPRequestStates.Aborted);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "ConnectionTimedOut"))
                {
                    translator.PushBestHTTPHTTPRequestStates(L, BestHTTP.HTTPRequestStates.ConnectionTimedOut);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "TimedOut"))
                {
                    translator.PushBestHTTPHTTPRequestStates(L, BestHTTP.HTTPRequestStates.TimedOut);
                }
				else
                {
                    return LuaAPI.luaL_error(L, "invalid string for BestHTTP.HTTPRequestStates!");
                }
            ...
            {
                return LuaAPI.luaL_error(L, "invalid lua type for BestHTTP.HTTPRequestStates! Expect number or string, got + " + lua_type);
            }
