...
namespace XLua.CSObjectWrap
{
    ...
    public class XAssetAssetsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(XAsset.Assets);
			...
			Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "bundleAssets", _g_get_bundleAssets);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					XAsset.Assets gen_ret = new XAsset.Assets();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to XAsset.Assets constructor!");
        ...
        static int _m_Initialize_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    System.Action _onSuccess = translator.GetDelegate<System.Action>(L, 1);
                    System.Action<string> _onError = translator.GetDelegate<System.Action<string>>(L, 2);
                    
                    XAsset.Assets.Initialize( _onSuccess, _onError );
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        string[] gen_ret = XAsset.Assets.GetAllDependencies( _path );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    bool _addictive = LuaAPI.lua_toboolean(L, 3);
                        ...
                        XAsset.SceneAsset gen_ret = XAsset.Assets.LoadScene( _path, _async, _addictive );
                        translator.Push(L, gen_ret);
        ...
        static int _m_UnloadScene_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    XAsset.Assets.UnloadScene( _path );
		    ...
		    try {
                ...
                
                {
                    ...
                    System.Type _type = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                        ...
                        XAsset.Asset gen_ret = XAsset.Assets.Load( _path, _type );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    System.Type _type = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                        ...
                        XAsset.Asset gen_ret = XAsset.Assets.LoadAsync( _path, _type );
                        translator.Push(L, gen_ret);
        ...
        static int _m_Unload_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    XAsset.Asset _asset = (XAsset.Asset)translator.GetObject(L, 1, typeof(XAsset.Asset));
                    
                    XAsset.Assets.Unload( _asset );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_bundleAssets(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, XAsset.Assets.bundleAssets);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
