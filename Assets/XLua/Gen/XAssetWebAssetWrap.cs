...
namespace XLua.CSObjectWrap
{
    ...
    public class XAssetWebAssetWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(XAsset.WebAsset);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					XAsset.WebAsset gen_ret = new XAsset.WebAsset();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to XAsset.WebAsset constructor!");
        ...
        static int _g_get_isDone(RealStatePtr L)
        {
		    try {
                ...
                XAsset.WebAsset gen_to_be_invoked = (XAsset.WebAsset)translator.FastGetCSObj(L, 1);
